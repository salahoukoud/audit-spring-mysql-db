...
/**
 * This class provides a utility method to turn the untyped AuditQuery
 * result list into a strongly typed list of AuditQueryResult.<br>
 * An AuditQuery returns a List of untyped Object[].
 */
